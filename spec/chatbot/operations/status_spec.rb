...
RSpec.describe Chatbot::Operations::Status do
  ...
  it_behaves_like 'operation', {
    'no spending' => {
      input: 'status',
      output: "You have €1,000 left for December. That's €58.82 per day for the rest of the month."
    },
    '100 euros spent' => {
      input: 'status',
      setup: 'create_spending 100_00, 5.days.ago',
      output: "You have €900 left for December. That's €52.94 per day for the rest of the month."
    },
    'multiple spendings' => {
      input: 'status',
      setup: "create_spending 100_00, 5.days.ago; create_spending 200_00, 10.days.ago",
      output: "You have €700 left for December. That's €41.17 per day for the rest of the month."
    },
    ...
    'leap year' => {
      ...
      output: "You have €900 left for February. That's €60 per day for the rest of the month."
    },
    'no budget set'  => {
      input: 'status',
    ...
    'last day of month' => {
      ...
      output: "You have €1,000 left for December. That's €1,000 per day for the rest of the month."
    },
    'spending with decimal amount' => {
      input: 'status',
      setup: 'create_spending 100_50, 5.days.ago',
      output: "You have €899.50 left for December. That's €52.91 per day for the rest of the month."
    },
